...
class SoftenerAdmin(admin.ModelAdmin):
    list_display = ('equipment', 'description', 'outline_dimension', 'interface_size', 'service_flow',
...
class PurifierAdmin(admin.ModelAdmin):
    list_display = ('equipment', 'description', 'outline_dimension', 'interface_size',
                    'filtering_accuracy', 'rated_flow', 'maximum_flow', 'water_pressure', 'water_temperature',
                    'cartridge_life')


class DrinkingAdmin(admin.ModelAdmin):
    list_display = ('equipment', 'description', 'outline_dimension', 'interface_size', 'maximum_tds',
